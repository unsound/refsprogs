...
#define REFS_FILE_ATTRIBUTE_READONLY                                (0x00000001)
#define REFS_FILE_ATTRIBUTE_HIDDEN                                  (0x00000002)
#define REFS_FILE_ATTRIBUTE_SYSTEM                                  (0x00000004)
#define REFS_FILE_ATTRIBUTE_DIRECTORY                               (0x00000010)
#define REFS_FILE_ATTRIBUTE_ARCHIVE                                 (0x00000020)
#define REFS_FILE_ATTRIBUTE_DEVICE                                  (0x00000040)
#define REFS_FILE_ATTRIBUTE_NORMAL                                  (0x00000080)
#define REFS_FILE_ATTRIBUTE_TEMPORARY                               (0x00000100)
#define REFS_FILE_ATTRIBUTE_SPARSE_FILE                             (0x00000200)
#define REFS_FILE_ATTRIBUTE_REPARSE_POINT                           (0x00000400)
#define REFS_FILE_ATTRIBUTE_COMPRESSED                              (0x00000800)
#define REFS_FILE_ATTRIBUTE_OFFLINE                                 (0x00001000)
#define REFS_FILE_ATTRIBUTE_NOT_CONTENT_INDEXED                     (0x00002000)
#define REFS_FILE_ATTRIBUTE_ENCRYPTED                               (0x00004000)
#define REFS_FILE_ATTRIBUTE_INTEGRITY_STREAM                        (0x00008000)
#define REFS_FILE_ATTRIBUTE_VIRTUAL                                 (0x00010000)
#define REFS_FILE_ATTRIBUTE_NO_SCRUB_DATA                           (0x00020000)
#define REFS_FILE_ATTRIBUTE_EA                                      (0x00040000)
#define REFS_FILE_ATTRIBUTE_PINNED                                  (0x00080000)
#define REFS_FILE_ATTRIBUTE_UNPINNED                                (0x00100000)
#define REFS_FILE_ATTRIBUTE_RECALL_ON_OPEN                          (0x00040000)
#define REFS_FILE_ATTRIBUTE_RECALL_ON_DATA_ACCESS                   (0x00400000)
