...
typedef enum {
	FSAPI_NODE_ATTRIBUTE_TYPE_SIZE = 0x1,
	FSAPI_NODE_ATTRIBUTE_TYPE_ALLOCATED_SIZE = 0x2,
	FSAPI_NODE_ATTRIBUTE_TYPE_LINK_COUNT = 0x4,
	FSAPI_NODE_ATTRIBUTE_TYPE_INODE_NUMBER = 0x8,
	FSAPI_NODE_ATTRIBUTE_TYPE_MODE = 0x10,
	FSAPI_NODE_ATTRIBUTE_TYPE_UID = 0x20,
	FSAPI_NODE_ATTRIBUTE_TYPE_GID = 0x40,
	FSAPI_NODE_ATTRIBUTE_TYPE_CREATION_TIME = 0x80,
	FSAPI_NODE_ATTRIBUTE_TYPE_LAST_STATUS_CHANGE_TIME = 0x100,
	FSAPI_NODE_ATTRIBUTE_TYPE_LAST_DATA_CHANGE_TIME = 0x200,
